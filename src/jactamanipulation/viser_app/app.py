...
class SimulationProcess(Process):
    ...
    def write_states(self) -> None:
        ...
        with self.context.state_lock:
            ...
            self.context.state_buffer["additional_info"] = copy(self.task.additional_task_info)
...
class ControlProcess(multiprocessing.Process):
    ...
    def write_traces(self) -> None:
        ...
        with self.context.control_lock:
            ...
            self.context.control_buffer["all_traces_rollout_size"] = self.controller.all_traces_rollout_size
